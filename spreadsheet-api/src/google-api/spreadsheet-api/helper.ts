...
export async function updateStockByStockCode(auth: string, code: string): GaxiosPromise<sheets_v4.Schema$UpdateValuesResponse> {
...
export async function getStockByStockCode(auth: string, code?: string): GaxiosPromise<sheets_v4.Schema$BatchGetValuesResponse> {
    const sheet = google.sheets('v4');
